          ...
          <div className="space-y-4">
            ...
            >
              ...
              {loadingProvider === "google" ? (
                <span className="relative z-10 w-5 h-5 border-2 border-mosque/40 border-t-mosque rounded-full animate-spin" />
              ) : (
                <svg
              ...
              <span className="relative z-10">{dict.auth.continueWithGoogle}</span>
            </button>
            ...
            >
              ...
              {loadingProvider === "github" ? (
                ...
                <svg
                  className="w-5 h-5 relative z-10 flex-shrink-0 fill-current text-nordic-dark dark:text-white"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <span className="relative z-10">{dict.auth.continueWithGithub}</span>
            </button>
          </div>
